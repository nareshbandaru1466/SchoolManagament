  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Calendar style={{ borderRadius: 10, elevation: 4, width: scale(328), marginBottom: SpacingSize.marginSmall }}
        ...
        <View style={styles.flatlistbox2}>
          ...
          <View style={styles.typebox}>
            <View style={styles.wtihtwo}>
              <Text style={{
                color: '#6E6E6E', marginLeft: SpacingSize.marginExtraLarge, alignSelf: "center",
                fontSize: moderateScale(SpacingSize.fontsizeSmall,), fontFamily: Constants.PrimaryFont,
              }}>Type your concern here !</Text>
...
export default DailychoosemonthScreen
